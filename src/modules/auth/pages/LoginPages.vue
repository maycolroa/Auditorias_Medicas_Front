<template>
  ...
  <div class="flex h-screen">
    ...
    <div class="hidden lg:flex items-center justify-center w-1/2 bg-gray-100">
      <img src="@/assets/logomediano.png" alt="Placeholder Image" class="object-cover w-72 h-72">
    </div>
    ...
    <div class="flex items-center justify-center w-full lg:w-1/2 p-8 lg:px-36 md:px-52 sm:px-20 bg-white">
      <div>
        ...
        <form @submit.prevent="onLogin">
          ...
          <!-- Login Button -->
          <button type="submit" class="bg-emerald-500 hover:bg-emerald-400 text-white font-semibold rounded-md py-2 px-4 w-full">Ingresar</button>
        </form>
